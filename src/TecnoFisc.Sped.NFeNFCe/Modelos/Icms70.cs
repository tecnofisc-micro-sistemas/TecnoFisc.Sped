...
/// <summary>
/// Variante <c>ICMS70</c> — com redução de BC e cobrança do ICMS por substituição tributária (CST 70).
/// </summary>
public sealed record Icms70 : Icms
{
    /// <summary><c>CST</c> — situação tributária do ICMS (sempre "70" nesta variante).</summary>
