...
public sealed class RegistroF129Tests
{
    private static readonly IRegistroSpedCatalogo _catalogo =
        CatalogoBuilder.BuildFromAssembly(typeof(RegistroF129).Assembly);

    [Fact]
    public void Atributo_DeclaraF129_Nivel4_BlocoF()
    {
        var atributo = typeof(RegistroF129).GetCustomAttribute<RegistroSpedAttribute>();

        atributo.Should().NotBeNull();
        atributo!.Codigo.Should().Be("F129");
        atributo.Nivel.Should().Be(4);
        atributo.Bloco.Should().Be("F");
    }

    [Fact]
    public void Catalogo_ExpoeRegistroF129ComDoisCamposNaOrdem()
    {
        _catalogo.TentarObter("F129".AsSpan(), out var meta).Should().BeTrue();

        meta!.Codigo.Should().Be("F129");
    ...
    {
        _catalogo.TentarObter("F129".AsSpan(), out var meta);
        var registro = (RegistroF129)meta!.Fabrica();
    ...
    {
        const string sped = "|F129|10166.720001/2020-31|1|\r\n";
    ...
    {
        const string sped = "|F129|10166.720001/2020-31|3|\r\n";
