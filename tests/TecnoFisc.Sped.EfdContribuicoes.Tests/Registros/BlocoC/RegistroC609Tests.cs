...
public sealed class RegistroC609Tests
{
    private static readonly IRegistroSpedCatalogo _catalogo =
        CatalogoBuilder.BuildFromAssembly(typeof(RegistroC609).Assembly);

    [Fact]
    public void Atributo_DeclaraCodigoC609_Nivel4_BlocoC()
    {
        var atributo = typeof(RegistroC609).GetCustomAttribute<RegistroSpedAttribute>();

        atributo.Should().NotBeNull();
        atributo!.Codigo.Should().Be("C609");
        atributo.Nivel.Should().Be(4);
        atributo.Bloco.Should().Be("C");
    }

    [Fact]
    public void Catalogo_ExpoeRegistroC609ComDoisCamposNaOrdem()
    {
        _catalogo.TentarObter("C609".AsSpan(), out var meta).Should().BeTrue();

        meta!.Codigo.Should().Be("C609");
    ...
    {
        _catalogo.TentarObter("C609".AsSpan(), out var meta);
        var registro = (RegistroC609)meta!.Fabrica();
    ...
    {
        const string sped = "|C609|10166.720001/2020-31|1|\r\n";
    ...
    {
        const string sped = "|C609|10166.720001/2020-31|3|\r\n";
