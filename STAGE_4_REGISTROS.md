...
| Sub-stage | Registro | Descrição | Página PDF |
| --- | --- | --- | --- |
| 4.001 | Registro 0000 | Abertura do Arquivo Digital e Identificação da Pessoa Jurídica | 66 |
| 4.002 | Registro 0001 | Abertura do Bloco 0 | 69 |
| 4.003 | Registro 0035 | Identificação de Sociedade em Conta de Participação – SCP | 69 |
| 4.004 | Registro 0100 | Dados do Contabilista | 70 |
...
| 4.021 | Registro 0990 | Encerramento do Bloco 0 | 94 |

### Bloco A — Documentos Fiscais (Serviços Sujeitos ao ISS)

| Sub-stage | Registro | Descrição | Página PDF |
| --- | --- | --- | --- |
| 4.022 | Registro A001 | Abertura do Bloco A | 95 |
...
| 4.029 | Registro A990 | Encerramento do Bloco A | 104 |

### Bloco C — Documentos Fiscais I (Mercadorias / ICMS-IPI)

| Sub-stage | Registro | Descrição | Página PDF |
| --- | --- | --- | --- |
| 4.030 | Registro C001 | Abertura do Bloco C | 104 |
...
| 4.077 | Registro C990 | Encerramento do Bloco C | 192 |

### Bloco D — Documentos Fiscais II (Serviços / ICMS)

| Sub-stage | Registro | Descrição | Página PDF |
| --- | --- | --- | --- |
| 4.078 | Registro D001 | Abertura do Bloco D | 193 |
...
| 4.100 | Registro D990 | Encerramento do Bloco D | 228 |

### Bloco F — Demais Documentos e Operações

| Sub-stage | Registro | Descrição | Página PDF |
| --- | --- | --- | --- |
| 4.101 | Registro F001 | Abertura do Bloco F | 229 |
...
| 4.126 | Registro F990 | Encerramento do Bloco F | 283 |

### Bloco I — Operações de Instituições Financeiras, Seguradoras e Assemelhados

| Sub-stage | Registro | Descrição | Página PDF |
| --- | --- | --- | --- |
| 4.127 | Registro I001 | Abertura do Bloco I | 284 |
...
| 4.135 | Registro I990 | Encerramento do Bloco I | 294 |

### Bloco M — Apuração da Contribuição e Crédito do PIS/Pasep e Cofins

| Sub-stage | Registro | Descrição | Página PDF |
| --- | --- | --- | --- |
| 4.136 | Registro M001 | Abertura do Bloco M | 295 |
...
| 4.168 | Registro M990 | Encerramento do Bloco M | 362 |

### Bloco P — Apuração da Contribuição Previdenciária Sobre a Receita Bruta (CPRB)

| Sub-stage | Registro | Descrição | Página PDF |
| --- | --- | --- | --- |
| 4.169 | Registro P001 | Abertura do Bloco P | 366 |
...
| 4.176 | Registro P990 | Encerramento do Bloco P | 374 |

### Bloco 1 — Complemento da Escrituração

| Sub-stage | Registro | Descrição | Página PDF |
| --- | --- | --- | --- |
| 4.177 | Registro 1001 | Abertura do Bloco 1 | 375 |
...
| 4.199 | Registro 1990 | Encerramento do Bloco 1 | 413 |

### Bloco 9 — Controle e Encerramento do Arquivo Digital

| Sub-stage | Registro | Descrição | Página PDF |
| --- | --- | --- | --- |
| 4.200 | Registro 9001 | Abertura do Bloco 9 | 415 |
| 4.201 | Registro 9900 | Registros do Arquivo | 415 |
| 4.202 | Registro 9990 | Encerramento do Bloco 9 | 415 |
| 4.203 | Registro 9999 | Encerramento do Arquivo Digital | 416 |
