...
public sealed class RegistroD111Tests
{
    private static readonly IRegistroSpedCatalogo _catalogo =
        CatalogoBuilder.BuildFromAssembly(typeof(RegistroD111).Assembly);

    [Fact]
    public void Atributo_DeclaraD111_Nivel4_BlocoD()
    {
        var atributo = typeof(RegistroD111).GetCustomAttribute<RegistroSpedAttribute>();

        atributo.Should().NotBeNull();
        atributo!.Codigo.Should().Be("D111");
        atributo.Nivel.Should().Be(4);
        atributo.Bloco.Should().Be("D");
    }

    [Fact]
    public void Catalogo_ExpoeRegistroD111ComDoisCamposNaOrdem()
    {
        _catalogo.TentarObter("D111".AsSpan(), out var meta).Should().BeTrue();

        meta!.Codigo.Should().Be("D111");
    ...
    {
        _catalogo.TentarObter("D111".AsSpan(), out var meta);
        var registro = (RegistroD111)meta!.Fabrica();
    ...
    {
        const string sped = "|D111|PROC-2021-001|1|\r\n";
    ...
    {
        const string sped = "|D111|ADM-RFB-2020-0099|3|\r\n";
