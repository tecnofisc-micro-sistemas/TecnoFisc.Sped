...
| [x] | 14.4 | **Polimorfismo de impostos completo:** ICMS (todos CST/CSOSN + ICMSPart/ICMSST/ICMSSN/FCP/desoneração), IPI, PIS, COFINS, II, ISSQN. ← **decisão sobre source generator entra após esta slice — PENDENTE (ver §3: avaliar com ~10-15 desserializadores manuais já existentes).** |
