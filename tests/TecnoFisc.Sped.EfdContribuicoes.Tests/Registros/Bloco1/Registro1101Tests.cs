...
public sealed class Registro1101Tests
{
    private static readonly IRegistroSpedCatalogo _catalogo =
        CatalogoBuilder.BuildFromAssembly(typeof(Registro1101).Assembly);

    [Fact]
    public void Atributo_Declara1101_Nivel3_Bloco1()
    {
        var atributo = typeof(Registro1101).GetCustomAttribute<RegistroSpedAttribute>();

        atributo.Should().NotBeNull();
        atributo!.Codigo.Should().Be("1101");
        atributo.Nivel.Should().Be(3);
        atributo.Bloco.Should().Be("1");
    }

    [Fact]
    public void Catalogo_ExpoeRegistro1101Com21CamposNaOrdem()
    {
        _catalogo.TentarObter("1101".AsSpan(), out var meta).Should().BeTrue();

        meta!.Codigo.Should().Be("1101");
        ...
        meta.Campos.Select(c => c.Nome).Should().Equal([
            ...
            "DtOper", "ChvNfe",
            "VlOper", "Cfop", "NatBcCred", "IndOrigCred", "CstPis",
        ...
        meta.Campos[12].Obrigatorio.Should().BeTrue();  // CstPis
        meta.Campos[13].Obrigatorio.Should().BeTrue();  // VlBcPis
        meta.Campos[14].Obrigatorio.Should().BeTrue();  // AliqPis
        meta.Campos[15].Obrigatorio.Should().BeTrue();  // VlPis
    ...
    {
        _catalogo.TentarObter("1101".AsSpan(), out var meta);
        var registro = (Registro1101)meta!.Fabrica();
        ...
        meta.Campos[12].Definidor(registro, "50".AsSpan());                                // CstPis
        meta.Campos[13].Definidor(registro, "1000,000".AsSpan());                          // VlBcPis
        meta.Campos[14].Definidor(registro, "0,6500".AsSpan());                            // AliqPis
        meta.Campos[15].Definidor(registro, "6,50".AsSpan());                              // VlPis
        ...
        registro.VlBcPis.Should().Be(1000.000m);
        registro.AliqPis.Should().Be(0.6500m);
    ...
    {
        const string sped = "|1101|PART001|ITEM001|55|001|SB1|123456789|01012021|35240111222333000181550010000000011000000018|1500,00|5102|01|0|50|1000,000|0,6500|6,50|CONTA001|CCUS001|Complementar|012021|11222333000181|\r\n";
    ...
    {
        const string sped = "|1101|||||||01012021||500,00||01|0|50|500,000|0,6500|3,25|||||11222333000181|\r\n";
    ...
    {
        const string sped = "|1101|PART002||||||15012021||2000,00||03|1|50|2000,000|0,6500|13,00||||012021|11222333000181|\r\n";
