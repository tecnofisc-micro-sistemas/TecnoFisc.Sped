namespace TecnoFisc.Sped.EfdIcmsIpi.Tests.Catalogo;

public sealed class OrdemCatalogoEfdIcmsIpiTests
{
    ...
    {
        // Oráculo literal: sequência de blocos conforme ArquivoEfdIcmsIpi._ordemBlocos,
        ...
        var seqEsperada = new[] { "0", "B", "C", "D", "E", "G", "H", "K", "1", "9" };
