...
/// <summary>
/// Sub-stage 8.127 — exercita a forma do <see cref="RegistroD190"/> contra o Guia Prático
/// EFD-ICMS/IPI V3.0.6 (p. 178): metadados de catálogo, mapeamento de campos e invariante
/// de round-trip parse → gerar → texto idêntico.
/// </summary>
public sealed class RegistroD190Tests
{
    private static readonly IRegistroSpedCatalogo _catalogo =
        CatalogoBuilder.BuildFromAssembly(typeof(RegistroD190).Assembly);
    ...
    [Fact]
    public void Atributo_DeclaraD190_Nivel3_BlocoD()
    {
        var atributo = typeof(RegistroD190).GetCustomAttribute<RegistroSpedAttribute>();

        atributo.Should().NotBeNull();
        atributo!.Codigo.Should().Be("D190");
        atributo.Nivel.Should().Be(3);
        atributo.Bloco.Should().Be("D");
    }

    [Fact]
    public void Catalogo_ExpoeRegistroD190Com8CamposNaOrdem()
    {
        _catalogo.TentarObter("D190".AsSpan(), out var meta).Should().BeTrue();

        meta!.Codigo.Should().Be("D190");
    ...
    {
        _catalogo.TentarObter("D190".AsSpan(), out var meta);
        var registro = (RegistroD190)meta!.Fabrica();
        ...
        registro.Cfop.Should().Be(Cfop.Criar("5351".AsSpan()));
    ...
    public async Task RoundTrip_ComTodosOsCampos_PreservaTextoCanonico()
    {
        ...
        const string sped =
            "|D190|100|5351|12,00|15000,00|12500,00|1500,00|2500,00|OBS001|\r\n";
    ...
    {
        // CST 41 (não tributado): ALIQ_ICMS vazio, valores monetários zerados, sem COD_OBS.
        const string sped =
            "|D190|41|5351||10000,00|0,00|0,00|0,00||\r\n";
    ...
    public async Task RoundTrip_ComReducaoBaseCalculo_PreservaTextoCanonico()
    {
        ...
        const string sped =
            "|D190|20|6351|12,00|8000,00|4000,00|480,00|4000,00||\r\n";
