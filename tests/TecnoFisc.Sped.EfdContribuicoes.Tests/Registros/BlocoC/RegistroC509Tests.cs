...
public sealed class RegistroC509Tests
{
    private static readonly IRegistroSpedCatalogo _catalogo =
        CatalogoBuilder.BuildFromAssembly(typeof(RegistroC509).Assembly);

    [Fact]
    public void Atributo_DeclaraCodigoC509_Nivel4_BlocoC()
    {
        var atributo = typeof(RegistroC509).GetCustomAttribute<RegistroSpedAttribute>();

        atributo.Should().NotBeNull();
        atributo!.Codigo.Should().Be("C509");
        atributo.Nivel.Should().Be(4);
        atributo.Bloco.Should().Be("C");
    }

    [Fact]
    public void Catalogo_ExpoeRegistroC509ComDoisCamposNaOrdem()
    {
        _catalogo.TentarObter("C509".AsSpan(), out var meta).Should().BeTrue();

        meta!.Codigo.Should().Be("C509");
    ...
    {
        _catalogo.TentarObter("C509".AsSpan(), out var meta);
        var registro = (RegistroC509)meta!.Fabrica();
    ...
    {
        const string sped = "|C509|10166.720001/2020-31|1|\r\n";
    ...
    {
        const string sped = "|C509|10166.720001/2020-31|3|\r\n";
