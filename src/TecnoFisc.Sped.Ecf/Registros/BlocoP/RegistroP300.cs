...
/// <summary>Registro P300 - cálculo do IRPJ no lucro presumido.</summary>
[RegistroSped(Codigo = "P300", Nivel = 3, Bloco = "P")]
public sealed partial class RegistroP300 : RegistroSped
{
    /// <inheritdoc />
    public override string Codigo => "P300";
