...
/// Conforme Guia Prático EFD Contribuições v1.35, p. 323.
/// </summary>
[RegistroSped(Codigo = "M230", Nivel = 4, Bloco = "M")]
public sealed partial class RegistroM230 : RegistroSped
{
    public override string Codigo => "M230";
