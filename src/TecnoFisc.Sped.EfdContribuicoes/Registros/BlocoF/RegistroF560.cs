...
/// <summary>
/// Registro F560 — Consolidação das Operações da Pessoa Jurídica Submetida ao Regime de Tributação
/// com Base no Lucro Presumido – Incidência do PIS/Pasep e da Cofins pelo Regime de Competência
/// (Apuração da Contribuição por Unidade de Medida de Produto – Alíquota em Reais).
/// Nível hierárquico 3, ocorrência 1:N.
/// Conforme Guia Prático EFD Contribuições v1.35, p. 273.
/// </summary>
[RegistroSped(Codigo = "F560", Nivel = 3, Bloco = "F")]
public sealed partial class RegistroF560 : RegistroSped
{
    public override string Codigo => "F560";
