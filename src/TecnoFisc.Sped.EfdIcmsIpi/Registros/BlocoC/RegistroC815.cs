...
/// Sujeitas à Substituição Tributária (CF-SAT) (cód. 59).
/// A obrigatoriedade e a forma de escrituração são definidas pela UF de domicílio do contribuinte.
/// Nível hierárquico 4, ocorrência 1:1 por registro C810.
/// Conforme Guia Prático EFD-ICMS/IPI V3.0.6, p. 153.
/// </summary>
[RegistroSped(Codigo = "C815", Nivel = 4, Bloco = "C")]
public sealed partial class RegistroC815 : RegistroSped
{
    /// <inheritdoc />
    public override string Codigo => "C815";
    ...
    /// <summary>Valor unitário líquido da mercadoria/produto na unidade utilizada para informar QUANT_CONV.</summary>
