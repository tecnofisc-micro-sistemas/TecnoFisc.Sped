...
public sealed class RegistroM211Tests
{
    private static readonly IRegistroSpedCatalogo _catalogo =
        CatalogoBuilder.BuildFromAssembly(typeof(RegistroM211).Assembly);

    [Fact]
    public void Atributo_DeclaraM211_Nivel4_BlocoM()
    {
        var atributo = typeof(RegistroM211).GetCustomAttribute<RegistroSpedAttribute>();

        atributo.Should().NotBeNull();
        atributo!.Codigo.Should().Be("M211");
        atributo.Nivel.Should().Be(4);
        atributo.Bloco.Should().Be("M");
    }

    [Fact]
    public void Catalogo_ExpoeRegistroM211Com5CamposNaOrdem()
    {
        _catalogo.TentarObter("M211".AsSpan(), out var meta).Should().BeTrue();

        meta!.Codigo.Should().Be("M211");
    ...
    {
        _catalogo.TentarObter("M211".AsSpan(), out var meta);
        var registro = (RegistroM211)meta!.Fabrica();
        ...
        meta.Campos[3].Definidor(registro, "2000,00".AsSpan());     // VlExcEspCoop
        meta.Campos[4].Definidor(registro, "93000,00".AsSpan());    // VlBcCont
        ...
        registro.VlExcEspCoop.Should().Be(2000m);
        registro.VlBcCont.Should().Be(93000m);
    }
    ...
    {
        const string sped = "|M211|01|100000,00|5000,00|2000,00|93000,00|\r\n";
    ...
    [Fact]
    public async Task RoundTrip_SemExclusoes_PreservaTextoCanonico()
    {
        const string sped = "|M211|03|80000,00|||80000,00|\r\n";
