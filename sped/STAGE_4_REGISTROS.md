...
| [x] | 4.043 | Registro C191 | Detalhamento da Consolidação – Aquisições/Devoluções – PIS/Pasep | 139 |
...
| [x] | 4.057 | Registro C490 | Consolidação de Documentos Emitidos por ECF (02, 2D, 59, 60) | 160 |
...
| [x] | 4.065 | Registro C600 | Consolidação Diária NF Energia/Água/Gás – Saída | 172 |
...
| [x] | 4.185 | Registro 1200 | Contribuição Social Extemporânea – PIS/Pasep | 391 |
| [x] | 4.186 | Registro 1210 | Detalhamento da Contribuição Social Extemporânea – PIS/Pasep | 392 |
...
| [x] | 4.194 | Registro 1620 | Demonstração do Crédito a Descontar da Contribuição Extemporânea – Cofins | 405 |
...
- **Other SPED leiautes:** this file documents only EFD Contribuições. Outros leiautes dentro do escopo da biblioteca (EFD ICMS-IPI, ECD, ECF — ver `ARCHITECTURE.md` §3 para a lista autoritativa) são rastreados em apêndices próprios, gerados da mesma forma a partir do *Guia Prático* / Manual de Orientação do respectivo leiaute quando sua stage começa.
