...
/// Nível hierárquico 5, ocorrência 1:N. Conforme Guia Prático EFD-ICMS/IPI V3.0.6, p. 217.
/// </summary>
[RegistroSped(Codigo = "E230", Nivel = 5, Bloco = "E")]
public sealed partial class RegistroE230 : RegistroSped
{
    /// <inheritdoc />
    public override string Codigo => "E230";
