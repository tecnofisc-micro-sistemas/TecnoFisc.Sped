...
/// <summary>
/// Registro D731 — Informações do Fundo de Combate à Pobreza (FCP) na NFCom (código 62).
/// Filho do <see cref="RegistroD730"/>; valores meramente informativos.
...
/// </para>
/// </remarks>
[RegistroSped(Codigo = "D731", Nivel = 4, Bloco = "D", IntroduzidoEm = (int)LayoutEfdIcmsIpi.V017)]
public sealed partial class RegistroD731 : RegistroSped
{
    /// <inheritdoc />
    public override string Codigo => "D731";

    /// <summary>Valor do FCP vinculado à operação própria, na combinação de CST_ICMS, CFOP e alíquota do ICMS do D730.</summary>
