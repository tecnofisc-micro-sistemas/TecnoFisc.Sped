...
public sealed class RegistroC870Tests
{
    ...
    [Fact]
    public void Atributo_DeclaraC870_Nivel4_BlocoC()
    {
    ...
    [Fact]
    public void Catalogo_ExpoeRegistroC870ComTrezeCamposNaOrdem()
    {
    ...
    public void Definidor_AtribuiTodosOsCampos()
    {
        ...
        meta.Campos[4].Definidor(registro, "01".AsSpan());            // CstPis
        meta.Campos[5].Definidor(registro, "950,00".AsSpan());        // VlBcPis
        meta.Campos[6].Definidor(registro, "0,6500".AsSpan());        // AliqPis
        meta.Campos[7].Definidor(registro, "6,18".AsSpan());          // VlPis
        meta.Campos[8].Definidor(registro, "01".AsSpan());            // CstCofins
        meta.Campos[9].Definidor(registro, "950,00".AsSpan());        // VlBcCofins
        meta.Campos[10].Definidor(registro, "3,0000".AsSpan());       // AliqCofins
        meta.Campos[11].Definidor(registro, "28,50".AsSpan());        // VlCofins
    ...
    {
        const string sped = "|C870|PROD001|5102|1000,00|50,00|49|950,00|0,6500|6,18|49|950,00|3,0000|28,50|3.1.01.001|\r\n";
    ...
    {
        const string sped = "|C870||5102|1000,00||49||||49|||||\r\n";
    ...
    {
        const string sped = "|C870||5102|500,00||99||||99|||||\r\n";
