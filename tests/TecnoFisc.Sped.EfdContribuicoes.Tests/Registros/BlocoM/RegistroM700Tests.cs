...
public sealed class RegistroM700Tests
{
    private static readonly IRegistroSpedCatalogo _catalogo =
        CatalogoBuilder.BuildFromAssembly(typeof(RegistroM700).Assembly);

    [Fact]
    public void Atributo_DeclaraM700_Nivel2_BlocoM()
    {
        var atributo = typeof(RegistroM700).GetCustomAttribute<RegistroSpedAttribute>();

        atributo.Should().NotBeNull();
        atributo!.Codigo.Should().Be("M700");
        atributo.Nivel.Should().Be(2);
        atributo.Bloco.Should().Be("M");
    }

    [Fact]
    public void Catalogo_ExpoeRegistroM700Com7CamposNaOrdem()
    {
        _catalogo.TentarObter("M700".AsSpan(), out var meta).Should().BeTrue();

        meta!.Codigo.Should().Be("M700");
    ...
    {
        _catalogo.TentarObter("M700".AsSpan(), out var meta);
        var registro = (RegistroM700)meta!.Fabrica();
        ...
        registro.NatCredDesc.Should().Be(NaturezaCreditoDiferido.CreditoAliquotaBasica);
    ...
    {
        const string sped =
            "|M700|51|5000,00|01|2000,00|3000,00|012024|15012024|\r\n";
    ...
    {
        const string sped = "|M700|51|3000,00|||3000,00|012024||\r\n";
