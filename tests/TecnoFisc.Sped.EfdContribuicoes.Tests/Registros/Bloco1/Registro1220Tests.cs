...
public sealed class Registro1220Tests
{
    private static readonly IRegistroSpedCatalogo _catalogo =
        CatalogoBuilder.BuildFromAssembly(typeof(Registro1220).Assembly);

    [Fact]
    public void Atributo_Declara1220_Nivel3_Bloco1()
    {
        var atributo = typeof(Registro1220).GetCustomAttribute<RegistroSpedAttribute>();

        atributo.Should().NotBeNull();
        atributo!.Codigo.Should().Be("1220");
        atributo.Nivel.Should().Be(3);
        atributo.Bloco.Should().Be("1");
    }

    [Fact]
    public void Catalogo_ExpoeRegistro1220Com4CamposNaOrdem()
    {
        _catalogo.TentarObter("1220".AsSpan(), out var meta).Should().BeTrue();

        meta!.Codigo.Should().Be("1220");
    ...
    {
        _catalogo.TentarObter("1220".AsSpan(), out var meta);
        var registro = (Registro1220)meta!.Fabrica();
    ...
    {
        const string sped = "|1220|012021|01|101|1500,00|\r\n";
    ...
    {
        const string sped = "|1220|032022|02|301|3250,75|\r\n";
