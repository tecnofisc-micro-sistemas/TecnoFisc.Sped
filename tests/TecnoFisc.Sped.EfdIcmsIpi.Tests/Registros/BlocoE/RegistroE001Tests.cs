...
/// <summary>
/// Sub-stage 8.154 — exercita a forma do <see cref="RegistroE001"/> contra o Guia Prático
...
public sealed class RegistroE001Tests
{
    private static readonly IRegistroSpedCatalogo _catalogo =
        CatalogoBuilder.BuildFromAssembly(typeof(RegistroE001).Assembly);
    ...
    [Fact]
    public void Atributo_DeclaraE001_Nivel1_BlocoE()
    {
        var atributo = typeof(RegistroE001).GetCustomAttribute<RegistroSpedAttribute>();

        atributo.Should().NotBeNull();
        atributo!.Codigo.Should().Be("E001");
        atributo.Nivel.Should().Be(1);
        atributo.Bloco.Should().Be("E");
    }

    [Fact]
    public void Catalogo_ExpoeRegistroE001ComUmCampoNaOrdem()
    {
        _catalogo.TentarObter("E001".AsSpan(), out var meta).Should().BeTrue();

        meta!.Codigo.Should().Be("E001");
    ...
    {
        _catalogo.TentarObter("E001".AsSpan(), out var meta);
        var registro = (RegistroE001)meta!.Fabrica();
