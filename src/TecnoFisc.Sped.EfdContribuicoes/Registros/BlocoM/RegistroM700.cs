...
/// Conforme Guia Prático EFD Contribuições v1.35, p. 358.
/// </summary>
[RegistroSped(Codigo = "M700", Nivel = 2, Bloco = "M")]
public sealed partial class RegistroM700 : RegistroSped
{
    public override string Codigo => "M700";
