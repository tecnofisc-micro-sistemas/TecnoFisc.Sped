...
/// <summary>
/// Registro X320 — existiu nos leiautes 8 a 10 e foi removido no leiaute 11.
...
/// Nível hierárquico confirmado no Manual ECF Leiaute 10 (Anexo ADE Cofis nº 59/2023, página 477).
/// </summary>
[RegistroSped(Codigo = "X320", Nivel = 2, Bloco = "X")]
[Descontinuado(EmVersao = (int)LayoutEcf.V011)]
public sealed partial class RegistroX320 : RegistroSped
{
    /// <inheritdoc />
    public override string Codigo => "X320";
}
