...
/// <summary>
/// Sub-stage 8.108 — exercita a forma do <see cref="RegistroC850"/> contra o Guia Prático
/// EFD-ICMS/IPI V3.0.6 (p. 156-157): metadados de catálogo, mapeamento de campos e invariante
/// de round-trip parse → gerar → texto idêntico.
/// </summary>
public sealed class RegistroC850Tests
{
    private static readonly IRegistroSpedCatalogo _catalogo =
        CatalogoBuilder.BuildFromAssembly(typeof(RegistroC850).Assembly);
    ...
    [Fact]
    public void Atributo_DeclaraC850_Nivel3_BlocoC()
    {
        var atributo = typeof(RegistroC850).GetCustomAttribute<RegistroSpedAttribute>();

        atributo.Should().NotBeNull();
        atributo!.Codigo.Should().Be("C850");
        atributo.Nivel.Should().Be(3);
        atributo.Bloco.Should().Be("C");
    }

    [Fact]
    public void Catalogo_ExpoeRegistroC850Com7CamposNaOrdem()
    {
        _catalogo.TentarObter("C850".AsSpan(), out var meta).Should().BeTrue();

        meta!.Codigo.Should().Be("C850");
    ...
    {
        _catalogo.TentarObter("C850".AsSpan(), out var meta);
        var registro = (RegistroC850)meta!.Fabrica();
    ...
    public async Task RoundTrip_ComTodosOsCampos_PreservaTextoCanonico()
    {
        ...
        const string sped =
            "|C850|60|5102|18,00|5000,00|4237,29|762,71|OBS001|\r\n";
