...
/// <summary>Registro N630 - apuração do IRPJ com base no lucro real.</summary>
[RegistroSped(Codigo = "N630", Nivel = 3, Bloco = "N")]
public sealed partial class RegistroN630 : RegistroSped
{
    /// <inheritdoc />
    public override string Codigo => "N630";
