...
public sealed class RegistroI199Tests
{
    private static readonly IRegistroSpedCatalogo _catalogo =
        CatalogoBuilder.BuildFromAssembly(typeof(RegistroI199).Assembly);

    [Fact]
    public void Atributo_DeclaraI199_Nivel4_BlocoI()
    {
        var atributo = typeof(RegistroI199).GetCustomAttribute<RegistroSpedAttribute>();

        atributo.Should().NotBeNull();
        atributo!.Codigo.Should().Be("I199");
        atributo.Nivel.Should().Be(4);
        atributo.Bloco.Should().Be("I");
    }

    [Fact]
    public void Catalogo_ExpoeRegistroI199Com2CamposNaOrdem()
    {
        _catalogo.TentarObter("I199".AsSpan(), out var meta).Should().BeTrue();

        meta!.Codigo.Should().Be("I199");
    ...
    {
        _catalogo.TentarObter("I199".AsSpan(), out var meta);
        var registro = (RegistroI199)meta!.Fabrica();

        meta.Campos[0].Definidor(registro, "12345-67.2020.4.01.0000".AsSpan()); // NumProc
        meta.Campos[1].Definidor(registro, "1".AsSpan());                        // IndProc

        registro.NumProc.Should().Be("12345-67.2020.4.01.0000");
    ...
    {
        const string sped = "|I199|12345-67.2020.4.01.0000|1|\r\n";
    ...
    {
        const string sped = "|I199|0012345-67.2020.4.02.0000|3|\r\n";
