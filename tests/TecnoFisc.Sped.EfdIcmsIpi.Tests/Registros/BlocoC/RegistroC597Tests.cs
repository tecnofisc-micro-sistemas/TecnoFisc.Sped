...
/// <summary>
/// Sub-stage 8.097 — exercita a forma do <see cref="RegistroC597"/> contra o Guia Prático
/// EFD-ICMS/IPI V3.2.2 (p. 146): metadados de catálogo, mapeamento de campos e invariante
/// de round-trip parse → gerar → texto idêntico.
/// </summary>
public sealed class RegistroC597Tests
{
    private static readonly IRegistroSpedCatalogo _catalogo =
        CatalogoBuilder.BuildFromAssembly(typeof(RegistroC597).Assembly);
    ...
    [Fact]
    public void Atributo_DeclaraC597_Nivel4_BlocoC()
    {
        var atributo = typeof(RegistroC597).GetCustomAttribute<RegistroSpedAttribute>();

        atributo.Should().NotBeNull();
        atributo!.Codigo.Should().Be("C597");
        atributo.Nivel.Should().Be(4);
        atributo.Bloco.Should().Be("C");
    }

    [Fact]
    public void Catalogo_ExpoeRegistroC597Com7CamposNaOrdem()
    {
        _catalogo.TentarObter("C597".AsSpan(), out var meta).Should().BeTrue();

        meta!.Codigo.Should().Be("C597");
    ...
    {
        _catalogo.TentarObter("C597".AsSpan(), out var meta);
        var registro = (RegistroC597)meta!.Fabrica();
    ...
    {
        const string sped =
            "|C597|RS10000001|Ajuste ICMS-ST|PROD001|1000,00|12,00|120,00|0,00|\r\n";
    ...
    [Fact]
    public async Task RoundTrip_AjusteInformativoSemIcms_PreservaTextoCanonico()
    {
        // Ajuste informativo: VL_ICMS vazio, VL_OUTROS preenchido conforme Tabela 5.3.
        const string sped =
            "|C597|SP99999999|Outros valores informativos|||||50,00|\r\n";
