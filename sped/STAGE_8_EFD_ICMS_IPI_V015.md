...
| [x] | 8.041 | Registro C111 | Complemento — Processo Referenciado | 68 |
| [x] | 8.042 | Registro C112 | Complemento — Documento de Arrecadação Referenciado | 68 |
| [x] | 8.043 | Registro C113 | Complemento — Documento Fiscal Referenciado | 69 |
| [x] | 8.044 | Registro C114 | Complemento — Cupom Fiscal Referenciado | 70 |
| [x] | 8.045 | Registro C115 | Local de Coleta e/ou Entrega (cód. 01, 1B e 04) | 70 |
...
| [x] | 8.055 | Registro C172 | Complemento de Item — Operações com ISSQN (cód. 01) | 82 |
| [x] | 8.056 | Registro C173 | Complemento de Item — Operações com Medicamentos (cód. 01, 55) | 83 |
...
| [x] | 8.065 | Registro C185 | Informações Complementares de Saída de Mercadorias Sujeitas a ST (cód. 01, 1B, 04, 55 e 65) | 96 |
...
| [x] | 8.070 | Registro C197 | Outras Obrigações Tributárias, Ajustes e Informações Provenientes do Documento Fiscal | 102 |
| [x] | 8.071 | Registro C300 | Documento — Resumo Diário das NF de Venda a Consumidor (cód. 02) | 103 |
| [x] | 8.072 | Registro C310 | Documentos Cancelados de NF de Venda a Consumidor (cód. 02) | 108 |
| [x] | 8.073 | Registro C320 | Registro Analítico das NF de Venda a Consumidor (cód. 02) | 105 |
...
| [x] | 8.078 | Registro C380 | Informações Complementares das Operações de Saída de Mercadorias Sujeitas a ST (cód. 02) | 110 |
| [x] | 8.079 | Registro C390 | Registro Analítico das NF de Venda a Consumidor (cód. 02) | 118 |
...
| [x] | 8.098 | Registro C600 | Consolidação Diária de NF/Contas (06, 29, 28) — Empresas Não Obrigadas ao Convênio ICMS 115/03 | 135 |
...
| [x] | 8.109 | Registro C860 | Identificação do Equipamento SAT-CF-e (cód. 59) | 158 |
...
| [x] | 8.115 | Registro D100 | NF Serviço de Transporte (07), CT (08, 8B, 09, 10, 11, 26, 27), CT-e (57, 67), Bilhete Passagem (63) | 165 |
| [x] | 8.116 | Registro D101 | Informação Complementar — Prestações Interestaduais a Consumidor Final Não Contribuinte EC 87/15 (57, 63, 67) | 169 |
...
| [x] | 8.135 | Registro D360 | PIS e COFINS Totalizados no Dia (cód. 2E, 13, 14, 15 e 16) | 188 |
| [x] | 8.136 | Registro D365 | Registro dos Totalizadores Parciais da Redução Z (cód. 2E, 13, 14, 15 e 16) | 189 |
...
| [x] | 8.161 | Registro E116 | Obrigações do ICMS a Recolher — Obrigações Próprias | 213 |
| [x] | 8.162 | Registro E200 | Período de Apuração do ICMS — Substituição Tributária | 214 |
| [x] | 8.163 | Registro E210 | Apuração do ICMS — Substituição Tributária | 215 |
| [x] | 8.164 | Registro E220 | Ajuste/Benefício/Incentivo da Apuração do ICMS — Substituição Tributária | 217 |
| [x] | 8.165 | Registro E230 | Informações Adicionais dos Ajustes da Apuração do ICMS Substituição Tributária | 218 |
...
| [x] | 8.170 | Registro E311 | Ajuste/Benefício/Incentivo da Apuração do ICMS Diferencial de Alíquota — UF Origem/Destino EC 87/15 | 225 |
| [x] | 8.171 | Registro E312 | Informações Adicionais dos Ajustes da Apuração do ICMS Diferencial de Alíquota — EC 87/15 | 226 |
...
| [x] | 8.179 | Registro E990 | Encerramento do Bloco E | 238 |

### Bloco G — CIAP — Controle de Crédito de ICMS do Ativo Permanente (7 registros)

| Feito | Sub-stage | Registro | Descrição | Página PDF |
| --- | --- | --- | --- | --- |
| [x] | 8.180 | Registro G001 | Abertura do Bloco G | 239 |
...
| [x] | 8.185 | Registro G140 | Identificação do Item do Documento Fiscal | 243 |
| [x] | 8.186 | Registro G990 | Encerramento do Bloco G | 244 |
...
| [x] | 8.192 | Registro H990 | Encerramento do Bloco H | 249 |
...
| [x] | 8.202 | Registro K255 | Industrialização em Terceiros — Insumos Consumidos | 257 |
| [x] | 8.203 | Registro K260 | Reprocessamento/Reparo de Produto/Insumo | 258 |
...
| [x] | 8.213 | Registro K302 | Produção Conjunta — Industrialização Efetuada por Terceiros — Insumos Consumidos | 271 |
| [x] | 8.214 | Registro K990 | Encerramento do Bloco K | 273 |
...
| [x] | 8.218 | Registro 1105 | Documentos Fiscais de Exportação | 277 |
...
| [x] | 8.223 | Registro 1255 | Informações Consolidadas de Saldos de Restituição, Ressarcimento e Complementação do ICMS por Motivo | 281 |
...
| [x] | 8.236 | Registro 1700 | Documentos Fiscais Utilizados | 286 |
| [x] | 8.237 | Registro 1710 | Documentos Fiscais Cancelados/Inutilizados | 287 |
...
| [x] | 8.253 | Registro 9900 | Registros do Arquivo | 302 |
| [x] | 8.254 | Registro 9990 | Encerramento do Bloco 9 | 302 |
| [x] | 8.255 | Registro 9999 | Encerramento do Arquivo Digital | 303 |
