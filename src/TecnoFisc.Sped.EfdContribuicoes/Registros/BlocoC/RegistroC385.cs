...
/// <summary>
/// Registro C385 — Detalhamento da Consolidação – Vendas a Consumidor – Cofins.
/// Nível hierárquico 4, ocorrência 1:N.
/// Conforme Guia Prático v1.35, p. 149.
/// </summary>
[RegistroSped(Codigo = "C385", Nivel = 4, Bloco = "C")]
public sealed partial class RegistroC385 : RegistroSped
{
    public override string Codigo => "C385";
