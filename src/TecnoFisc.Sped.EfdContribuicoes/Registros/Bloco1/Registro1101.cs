...
/// <summary>
/// Registro 1101 — Apuração de Crédito Extemporâneo - Documentos e Operações de Períodos
/// Anteriores – PIS/Pasep. Nível hierárquico 3, ocorrência 1:N. Filho do Registro 1100.
/// Conforme Guia Prático EFD Contribuições v1.35, p. 387.
/// </summary>
[RegistroSped(Codigo = "1101", Nivel = 3, Bloco = "1")]
public sealed partial class Registro1101 : RegistroSped
{
    /// <inheritdoc />
    public override string Codigo => "1101";
    ...
    /// <summary>Base de Cálculo do Crédito de PIS/PASEP (em valor ou em quantidade).</summary>
    [CampoSped(Ordem = 15, Tamanho = 0, Decimais = 3, Obrigatorio = true)]
    public decimal VlBcPis { get; set; }

    /// <summary>Alíquota do PIS/PASEP (em percentual ou em reais).</summary>
    [CampoSped(Ordem = 16, Tamanho = 0, Decimais = 4, Obrigatorio = true)]
    public decimal AliqPis { get; set; }

    /// <summary>Valor do Crédito de PIS/PASEP.</summary>
