...
/// <summary>
/// Registro F550 — Consolidação das Operações da Pessoa Jurídica Submetida ao Regime de Tributação
/// com Base no Lucro Presumido – Incidência do PIS/Pasep e da Cofins pelo Regime de Competência.
/// Nível hierárquico 3, ocorrência 1:N.
/// Conforme Guia Prático EFD Contribuições v1.35, p. 268.
/// </summary>
[RegistroSped(Codigo = "F550", Nivel = 3, Bloco = "F")]
public sealed partial class RegistroF550 : RegistroSped
{
    public override string Codigo => "F550";
