...
/// Conforme Guia Prático EFD Contribuições v1.35, p. 384.
/// </summary>
...
public sealed partial class Registro1100 : RegistroSped
{
    ...
    /// <summary>Valor total do crédito apurado na escrituração fiscal digital (Registro M100) ou demonstrativo DACON de período anterior.</summary>
    [CampoSped(Ordem = 6, Tamanho = 0, Decimais = 2, Obrigatorio = true)]
    public decimal VlCredApu { get; set; }

    /// <summary>Valor do crédito extemporâneo apurado (Registro 1101), referente ao período anterior informado no campo PER_APU_CRED.</summary>
