...
/// Conforme Guia Prático EFD Contribuições v1.35, p. 354.
/// </summary>
[RegistroSped(Codigo = "M615", Nivel = 4, Bloco = "M")]
public sealed partial class RegistroM615 : RegistroSped
{
    public override string Codigo => "M615";
