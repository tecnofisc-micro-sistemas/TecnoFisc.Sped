...
public sealed class RegistroP199Tests
{
    private static readonly IRegistroSpedCatalogo _catalogo =
        CatalogoBuilder.BuildFromAssembly(typeof(RegistroP199).Assembly);

    [Fact]
    public void Atributo_DeclaraP199_Nivel4_BlocoP()
    {
        var atributo = typeof(RegistroP199).GetCustomAttribute<RegistroSpedAttribute>();

        atributo.Should().NotBeNull();
        atributo!.Codigo.Should().Be("P199");
        atributo.Nivel.Should().Be(4);
        atributo.Bloco.Should().Be("P");
    }

    [Fact]
    public void Catalogo_ExpoeRegistroP199ComDoisCamposNaOrdem()
    {
        _catalogo.TentarObter("P199".AsSpan(), out var meta).Should().BeTrue();

        meta!.Codigo.Should().Be("P199");
    ...
    {
        _catalogo.TentarObter("P199".AsSpan(), out var meta);
        var registro = (RegistroP199)meta!.Fabrica();
    ...
    {
        const string sped = "|P199|10166.720001/2020-31|1|\r\n";
    ...
    {
        const string sped = "|P199|19515.720028/2021-51|3|\r\n";
