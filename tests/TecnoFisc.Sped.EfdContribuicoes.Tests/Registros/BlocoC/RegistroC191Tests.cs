...
public sealed class RegistroC191Tests
{
    ...
    [Fact]
    public void Catalogo_ExpoeRegistroC191Com11CamposNaOrdem()
    {
        ...
        [
            "CnpjCpfPart", "CstPis", "Cfop", "VlItem", "VlDesc",
    ...
    public void Definidor_AtribuiTodosOsCampos()
    {
        ...
        meta.Campos[5].Definidor(registro, "1900,00".AsSpan());        // VlBcPis
        meta.Campos[6].Definidor(registro, "1,6500".AsSpan());         // AliqPis
        meta.Campos[7].Definidor(registro, "20,000".AsSpan());         // QuantBcPis
        meta.Campos[8].Definidor(registro, "0,0100".AsSpan());         // AliqPisQuant
        meta.Campos[9].Definidor(registro, "31,35".AsSpan());          // VlPis
        ...
        registro.Cfop.Should().Be(Cfop.Create("1101"));
        registro.VlItem.Should().Be(2000m);
        registro.VlDesc.Should().Be(100m);
        registro.VlBcPis.Should().Be(1900m);
        registro.AliqPis.Should().Be(1.65m);
        registro.QuantBcPis.Should().Be(20m);
        registro.AliqPisQuant.Should().Be(0.01m);
        registro.VlPis.Should().Be(31.35m);
    ...
    {
        const string sped =
            "|C191|12345678000195|50|1101|2000,00|100,00|1900,00|1,6500|20,000|0,0100|31,35|1.2.01.001|\r\n";
