...
/// de serviço de comunicação e telecomunicação consolidados no D600.
/// Nível hierárquico 3, ocorrência 1:N.
/// Conforme Guia Prático EFD-ICMS/IPI V3.2.2, pp. 207-208.
/// </summary>
[RegistroSped(Codigo = "D690", Nivel = 3, Bloco = "D")]
public sealed partial class RegistroD690 : RegistroSped
{
    /// <inheritdoc />
    public override string Codigo => "D690";
