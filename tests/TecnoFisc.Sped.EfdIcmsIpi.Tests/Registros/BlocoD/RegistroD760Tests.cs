...
/// <summary>
/// Sub-stage 8.017.013 — exercita a forma do <see cref="RegistroD760"/> (analítico da escrituração
/// consolidada NFCom, código 62) contra o Guia Prático EFD-ICMS/IPI V3.2.2 (p. 220-221, Subseção 12):
/// metadados de catálogo, mapeamento de campos e invariante de round-trip parse → texto idêntico.
/// </summary>
public sealed class RegistroD760Tests
{
    private static readonly IRegistroSpedCatalogo _catalogo =
        CatalogoBuilder.BuildFromAssembly(typeof(RegistroD760).Assembly);
    ...
    [Fact]
    public void Atributo_DeclaraD760_Nivel3_BlocoD_IntroduzidoEmV017()
    {
        var atributo = typeof(RegistroD760).GetCustomAttribute<RegistroSpedAttribute>();

        atributo.Should().NotBeNull();
        atributo!.Codigo.Should().Be("D760");
    ...
    [Fact]
    public void Catalogo_ExpoeRegistroD760_Com8CamposNaOrdem()
    {
        _catalogo.TentarObter("D760".AsSpan(), out var meta).Should().BeTrue();

        meta!.Codigo.Should().Be("D760");
    ...
    {
        _catalogo.TentarObter("D760".AsSpan(), out var meta);
        var registro = (RegistroD760)meta!.Fabrica();
    ...
    public async Task RoundTrip_ComTodosOsCampos_PreservaTextoCanonico()
    {
        ...
        const string sped =
            "|D760|100|5351|12,00|15000,00|12500,00|1500,00|2500,00|OBS001|\r\n";
    ...
    public async Task RoundTrip_SemCamposOpcionais_PreservaTextoCanonico()
    {
        ...
        const string sped =
            "|D760|41|5351||10000,00|0,00|0,00|0,00||\r\n";
