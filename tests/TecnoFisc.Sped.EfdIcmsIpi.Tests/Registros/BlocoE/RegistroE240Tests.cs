...
/// <summary>
/// Sub-stage 8.166 — exercita a forma do <see cref="RegistroE240"/> contra o Guia Prático
/// EFD-ICMS/IPI V3.0.6 (p. 218): metadados de catálogo, mapeamento de campos e invariante
/// de round-trip parse → gerar → texto idêntico.
/// </summary>
public sealed class RegistroE240Tests
{
    ...
    private static readonly IRegistroSpedCatalogo _catalogo =
        CatalogoBuilder.BuildFromAssembly(typeof(RegistroE240).Assembly);
    ...
    [Fact]
    public void Atributo_DeclaraE240_Nivel5_BlocoE()
    {
        var atributo = typeof(RegistroE240).GetCustomAttribute<RegistroSpedAttribute>();

        atributo.Should().NotBeNull();
        atributo!.Codigo.Should().Be("E240");
        atributo.Nivel.Should().Be(5);
        atributo.Bloco.Should().Be("E");
    }

    [Fact]
    public void Catalogo_ExpoeRegistroE240Com9CamposNaOrdem()
    {
        _catalogo.TentarObter("E240".AsSpan(), out var meta).Should().BeTrue();

        meta!.Codigo.Should().Be("E240");
    ...
    {
        _catalogo.TentarObter("E240".AsSpan(), out var meta);
        var registro = (RegistroE240)meta!.Fabrica();
    ...
    [InlineData("55")]
    [InlineData("57")]
    public void Definidor_CodMod_MapeiaModeloDocumento(string valor)
    {
        _catalogo.TentarObter("E240".AsSpan(), out var meta);
        var registro = (RegistroE240)meta!.Fabrica();
    ...
    {
        var sped = $"|E240|FORN001|55|A|1|12345|01012023|PROD001|1500,00|{ChaveNfeValida}|\r\n";
    ...
    {
        const string sped = "|E240|FORN001|01|||12345|01012023||1500,00||\r\n";
