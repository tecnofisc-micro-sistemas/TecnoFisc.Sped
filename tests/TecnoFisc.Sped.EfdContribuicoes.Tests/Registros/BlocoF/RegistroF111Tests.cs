...
public sealed class RegistroF111Tests
{
    private static readonly IRegistroSpedCatalogo _catalogo =
        CatalogoBuilder.BuildFromAssembly(typeof(RegistroF111).Assembly);

    [Fact]
    public void Atributo_DeclaraCodigoF111_Nivel4_BlocoF()
    {
        var atributo = typeof(RegistroF111).GetCustomAttribute<RegistroSpedAttribute>();

        atributo.Should().NotBeNull();
        atributo!.Codigo.Should().Be("F111");
        atributo.Nivel.Should().Be(4);
        atributo.Bloco.Should().Be("F");
    }

    [Fact]
    public void Catalogo_ExpoeRegistroF111ComDoisCamposNaOrdem()
    {
        _catalogo.TentarObter("F111".AsSpan(), out var meta).Should().BeTrue();

        meta!.Codigo.Should().Be("F111");
    ...
    {
        _catalogo.TentarObter("F111".AsSpan(), out var meta);
        var registro = (RegistroF111)meta!.Fabrica();
    ...
    {
        const string sped = "|F111|10166.720001/2020-31|1|\r\n";
    ...
    {
        const string sped = "|F111|10166.720001/2020-31|3|\r\n";
