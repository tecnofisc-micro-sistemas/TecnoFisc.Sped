...
public sealed class RegistroF509Tests
{
    private static readonly IRegistroSpedCatalogo _catalogo =
        CatalogoBuilder.BuildFromAssembly(typeof(RegistroF509).Assembly);

    [Fact]
    public void Atributo_DeclaraF509_Nivel4_BlocoF()
    {
        var atributo = typeof(RegistroF509).GetCustomAttribute<RegistroSpedAttribute>();

        atributo.Should().NotBeNull();
        atributo!.Codigo.Should().Be("F509");
        atributo.Nivel.Should().Be(4);
        atributo.Bloco.Should().Be("F");
    }

    [Fact]
    public void Catalogo_ExpoeRegistroF509ComDoisCamposNaOrdem()
    {
        _catalogo.TentarObter("F509".AsSpan(), out var meta).Should().BeTrue();

        meta!.Codigo.Should().Be("F509");
    ...
    {
        _catalogo.TentarObter("F509".AsSpan(), out var meta);
        var registro = (RegistroF509)meta!.Fabrica();
    ...
    {
        const string sped = "|F509|10166.720001/2021-55|3|\r\n";
    ...
    {
        const string sped = "|F509|5001234-12.2022.4.01.3400|1|\r\n";
