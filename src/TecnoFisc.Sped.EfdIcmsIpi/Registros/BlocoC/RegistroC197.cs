...
/// Provenientes de Documento Fiscal. Filho do C195; detalha obrigações tributárias,
...
/// Conforme Guia Prático EFD-ICMS/IPI V3.0.6, p. 106.
/// </summary>
[RegistroSped(Codigo = "C197", Nivel = 4, Bloco = "C")]
public sealed partial class RegistroC197 : RegistroSped
{
    /// <inheritdoc />
    public override string Codigo => "C197";
