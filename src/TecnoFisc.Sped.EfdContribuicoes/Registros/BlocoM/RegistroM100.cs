...
/// Conforme Guia Prático EFD Contribuições v1.35, p. 295.
/// </summary>
[RegistroSped(Codigo = "M100", Nivel = 2, Bloco = "M")]
public sealed partial class RegistroM100 : RegistroSped
{
    public override string Codigo => "M100";
