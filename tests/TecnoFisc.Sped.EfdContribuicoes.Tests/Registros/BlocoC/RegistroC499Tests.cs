...
public sealed class RegistroC499Tests
{
    private static readonly IRegistroSpedCatalogo _catalogo =
        CatalogoBuilder.BuildFromAssembly(typeof(RegistroC499).Assembly);

    [Fact]
    public void Atributo_DeclaraCodigoC499_Nivel4_BlocoC()
    {
        var atributo = typeof(RegistroC499).GetCustomAttribute<RegistroSpedAttribute>();

        atributo.Should().NotBeNull();
        atributo!.Codigo.Should().Be("C499");
        atributo.Nivel.Should().Be(4);
        atributo.Bloco.Should().Be("C");
    }

    [Fact]
    public void Catalogo_ExpoeRegistroC499ComDoisCamposNaOrdem()
    {
        _catalogo.TentarObter("C499".AsSpan(), out var meta).Should().BeTrue();

        meta!.Codigo.Should().Be("C499");
    ...
    {
        _catalogo.TentarObter("C499".AsSpan(), out var meta);
        var registro = (RegistroC499)meta!.Fabrica();
    ...
    {
        const string sped = "|C499|10166.720001/2020-31|1|\r\n";
    ...
    {
        const string sped = "|C499|10166.720001/2020-31|3|\r\n";
