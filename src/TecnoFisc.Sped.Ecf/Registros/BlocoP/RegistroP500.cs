...
/// <summary>Registro P500 - cálculo da CSLL no lucro presumido.</summary>
[RegistroSped(Codigo = "P500", Nivel = 3, Bloco = "P")]
public sealed partial class RegistroP500 : RegistroSped
{
    /// <inheritdoc />
    public override string Codigo => "P500";
