...
/// Conforme Guia Prático EFD Contribuições v1.35, p. 339.
/// </summary>
[RegistroSped(Codigo = "M600", Nivel = 2, Bloco = "M")]
public sealed partial class RegistroM600 : RegistroSped
{
    public override string Codigo => "M600";
