...
public sealed class RegistroD309Tests
{
    private static readonly IRegistroSpedCatalogo _catalogo =
        CatalogoBuilder.BuildFromAssembly(typeof(RegistroD309).Assembly);

    [Fact]
    public void Atributo_DeclaraD309_Nivel4_BlocoD()
    {
        var atributo = typeof(RegistroD309).GetCustomAttribute<RegistroSpedAttribute>();

        atributo.Should().NotBeNull();
        atributo!.Codigo.Should().Be("D309");
        atributo.Nivel.Should().Be(4);
        atributo.Bloco.Should().Be("D");
    }

    [Fact]
    public void Catalogo_ExpoeRegistroD309ComDoisCamposNaOrdem()
    {
        _catalogo.TentarObter("D309".AsSpan(), out var meta).Should().BeTrue();

        meta!.Codigo.Should().Be("D309");
    ...
    {
        _catalogo.TentarObter("D309".AsSpan(), out var meta);
        var registro = (RegistroD309)meta!.Fabrica();
    ...
    {
        const string sped = "|D309|PROC-2021-001|1|\r\n";
    ...
    {
        const string sped = "|D309|ADM-RFB-2020-0099|3|\r\n";
