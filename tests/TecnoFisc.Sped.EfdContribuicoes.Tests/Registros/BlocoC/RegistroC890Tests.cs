...
public sealed class RegistroC890Tests
{
    ...
    [Fact]
    public void Atributo_DeclaraCodigoC890_Nivel4_BlocoC()
    {
    ...
    [Fact]
    public void Catalogo_ExpoeRegistroC890ComDoisCamposNaOrdem()
    {
    ...
    {
        const string sped = "|C890|10166.720001/2020-31|1|\r\n";
    ...
    {
        const string sped = "|C890|10166.720001/2020-31|3|\r\n";
