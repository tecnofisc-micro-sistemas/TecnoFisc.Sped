...
/// Provenientes de Documento Fiscal. Filho do D195; detalha obrigações tributárias,
...
/// Conforme Guia Prático EFD-ICMS/IPI V3.0.6, p. 180.
/// </summary>
[RegistroSped(Codigo = "D197", Nivel = 4, Bloco = "D")]
public sealed partial class RegistroD197 : RegistroSped
{
    /// <inheritdoc />
    public override string Codigo => "D197";
