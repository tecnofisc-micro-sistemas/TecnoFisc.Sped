...
public sealed class Registro0190Tests
{
    ...
    [Fact]
    public void Atributo_DeclaraCodigo0190_Nivel3_Bloco0()
    {
    ...
    [Fact]
    public void Catalogo_ExpoeRegistro0190ComDoisCamposNaOrdem()
    {
        _catalogo.TentarObter("0190".AsSpan(), out var meta).Should().BeTrue();

        meta!.Codigo.Should().Be("0190");
        meta.Campos.Select(c => c.Nome).Should().Equal(["Unid", "Descr"]);
    ...
    public void Definidor_CampoVazio_DevolveNulo()
    {
        ...
        // Ambos obrigatórios, mas o catálogo não impede atribuição de vazio
    ...
    [Fact]
    public async Task RoundTrip_CodigoComEspaco_PreservaTextoCanonico()
    {
        // UNID pode ter até 6 caracteres; DESCR é texto livre
