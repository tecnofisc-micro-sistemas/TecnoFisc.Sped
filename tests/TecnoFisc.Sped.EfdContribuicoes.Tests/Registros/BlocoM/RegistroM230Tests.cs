...
public sealed class RegistroM230Tests
{
    private static readonly IRegistroSpedCatalogo _catalogo =
        CatalogoBuilder.BuildFromAssembly(typeof(RegistroM230).Assembly);

    [Fact]
    public void Atributo_DeclaraM230_Nivel4_BlocoM()
    {
        var atributo = typeof(RegistroM230).GetCustomAttribute<RegistroSpedAttribute>();

        atributo.Should().NotBeNull();
        atributo!.Codigo.Should().Be("M230");
        atributo.Nivel.Should().Be(4);
        atributo.Bloco.Should().Be("M");
    }

    [Fact]
    public void Catalogo_ExpoeRegistroM230Com6CamposNaOrdem()
    {
        _catalogo.TentarObter("M230".AsSpan(), out var meta).Should().BeTrue();

        meta!.Codigo.Should().Be("M230");
    ...
    {
        _catalogo.TentarObter("M230".AsSpan(), out var meta);
        var registro = (RegistroM230)meta!.Fabrica();
    ...
    {
        const string sped =
            "|M230|11222333000181|10000,00|3000,00|1500,00|500,00|101|\r\n";
    ...
    {
        const string sped = "|M230|11222333000181|10000,00|3000,00|1500,00|||\r\n";
    ...
    [Theory]
    [InlineData("101", CodigoTipoCredito.MercadoInternoTributadoAliquotaBasica)]
    [InlineData("201", CodigoTipoCredito.MercadoInternoNaoTributadoAliquotaBasica)]
    [InlineData("301", CodigoTipoCredito.ExportacaoAliquotaBasica)]
    public void CodigoTipoCredito_Roundtrip_MapeiaCodigo(string codigo, CodigoTipoCredito esperado)
    {
        _catalogo.TentarObter("M230".AsSpan(), out var meta);
        var registro = (RegistroM230)meta!.Fabrica();
        ...
        registro.CodCred.Should().Be(esperado);
    }
