...
/// <summary>
/// Registro B035 — Detalhamento por Combinação de Alíquota e Item da Lista de Serviços (LC 116/2003).
/// Filho do B030. Nível hierárquico 3, ocorrência 1:N por B030 pai.
/// Conforme Guia Prático EFD-ICMS/IPI V3.0.6, p. 49-50.
/// </summary>
[RegistroSped(Codigo = "B035", Nivel = 3, Bloco = "B")]
public sealed partial class RegistroB035 : RegistroSped
{
    /// <inheritdoc />
    public override string Codigo => "B035";
