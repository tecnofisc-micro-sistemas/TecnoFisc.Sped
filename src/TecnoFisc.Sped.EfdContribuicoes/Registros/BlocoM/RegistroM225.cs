...
/// Nível hierárquico 5, ocorrência 1:N (filho de M220).
/// Conforme Guia Prático EFD Contribuições v1.35, p. 321.
/// </summary>
[RegistroSped(Codigo = "M225", Nivel = 5, Bloco = "M")]
public sealed partial class RegistroM225 : RegistroSped
{
    public override string Codigo => "M225";

    /// <summary>Detalhamento do valor do ajuste da contribuição (campo VL_AJ do M220).</summary>
