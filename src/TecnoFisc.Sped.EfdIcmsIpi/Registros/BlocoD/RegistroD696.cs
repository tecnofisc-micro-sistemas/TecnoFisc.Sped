...
/// <summary>
/// Registro D696 — Registro Analítico dos Documentos (Códigos 21 e 22).
/// Totaliza por combinação de CST_ICMS, CFOP e alíquota do ICMS os documentos
/// de serviço de comunicação e telecomunicação consolidados no D695.
/// Nível hierárquico 3, ocorrência 1:N.
/// Conforme Guia Prático EFD-ICMS/IPI V3.0.6, pp. 203-204.
/// </summary>
[RegistroSped(Codigo = "D696", Nivel = 3, Bloco = "D")]
public sealed partial class RegistroD696 : RegistroSped
{
    /// <inheritdoc />
    public override string Codigo => "D696";
