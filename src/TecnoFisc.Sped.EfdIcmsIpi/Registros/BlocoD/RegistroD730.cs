...
/// <summary>
/// Registro D730 — Registro analítico da Nota Fiscal Fatura Eletrônica de Serviços de Comunicação
/// (NFCom, código 62). Totaliza por combinação de CST_ICMS, CFOP e alíquota do ICMS as informações
/// do documento fiscal do <see cref="RegistroD700"/>.
/// Nível hierárquico 3, ocorrência 1:N (filho de D700).
/// Conforme Guia Prático EFD-ICMS/IPI V3.2.2, p. 215-217 (Subseção 12).
/// </summary>
/// <remarks>
...
/// D730 com a mesma combinação de <c>CST_ICMS</c>, <c>CFOP</c> e <c>ALIQ_ICMS</c> para o mesmo
...
/// </para>
/// </remarks>
[RegistroSped(Codigo = "D730", Nivel = 3, Bloco = "D", IntroduzidoEm = (int)LayoutEfdIcmsIpi.V017)]
public sealed partial class RegistroD730 : RegistroSped
{
    /// <inheritdoc />
    public override string Codigo => "D730";
