...
/// <summary>Registro T150 - cálculo do IRPJ no lucro arbitrado.</summary>
[RegistroSped(Codigo = "T150", Nivel = 3, Bloco = "T")]
public sealed partial class RegistroT150 : RegistroSped
{
    /// <inheritdoc />
    public override string Codigo => "T150";
