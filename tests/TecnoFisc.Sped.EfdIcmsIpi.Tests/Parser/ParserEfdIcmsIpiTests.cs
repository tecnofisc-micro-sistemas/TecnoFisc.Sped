...
public sealed class ParserEfdIcmsIpiTests
{
    ...
    [Fact]
    public async Task LerStreamingAsync_ConstrutorPadrao_UsaCatalogoDoLeiauteEfdIcmsIpi()
    {
    ...
    {
        var act = () => new ParserEfdIcmsIpi(catalogo: null!);
    ...
    public async Task LerStreamingAsync_ComCatalogoCustomizado_DelegaParaCatalogoInjetado()
    {
        ...
        var parser = new ParserEfdIcmsIpi(catalogoCore);
