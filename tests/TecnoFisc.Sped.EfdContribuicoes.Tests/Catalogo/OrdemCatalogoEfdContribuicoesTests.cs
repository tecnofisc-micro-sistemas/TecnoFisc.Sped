...
public sealed class OrdemCatalogoEfdContribuicoesTests
{
    ...
    {
        // Oráculo literal: sequência de blocos conforme ArquivoEfdContribuicoes._ordemBlocos,
        ...
        var seqEsperada = new[] { "0", "A", "C", "D", "F", "I", "M", "P", "1", "9" };
