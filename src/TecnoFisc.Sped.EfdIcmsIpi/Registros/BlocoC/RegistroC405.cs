...
/// Informações da Redução Z de cada equipamento ECF em funcionamento na data das operações,
/// incluindo todos os documentos fiscais totalizados na Redução Z.
/// Nível hierárquico 3, ocorrência 1:N por C400.
/// Conforme Guia Prático EFD-ICMS/IPI V3.0.6, p. 119.
/// </summary>
[RegistroSped(Codigo = "C405", Nivel = 3, Bloco = "C")]
public sealed partial class RegistroC405 : RegistroSped
{
    ...
    /// <summary>Número do Contador de Ordem de Operação do último documento emitido no dia (número do COO na Redução Z).</summary>
