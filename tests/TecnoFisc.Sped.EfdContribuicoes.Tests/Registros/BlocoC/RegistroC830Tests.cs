...
public sealed class RegistroC830Tests
{
    private static readonly IRegistroSpedCatalogo _catalogo =
        CatalogoBuilder.BuildFromAssembly(typeof(RegistroC830).Assembly);

    [Fact]
    public void Atributo_DeclaraCodigoC830_Nivel4_BlocoC()
    {
        var atributo = typeof(RegistroC830).GetCustomAttribute<RegistroSpedAttribute>();

        atributo.Should().NotBeNull();
        atributo!.Codigo.Should().Be("C830");
        atributo.Nivel.Should().Be(4);
        atributo.Bloco.Should().Be("C");
    }

    [Fact]
    public void Catalogo_ExpoeRegistroC830ComDoisCamposNaOrdem()
    {
        _catalogo.TentarObter("C830".AsSpan(), out var meta).Should().BeTrue();

        meta!.Codigo.Should().Be("C830");
    ...
    {
        _catalogo.TentarObter("C830".AsSpan(), out var meta);
        var registro = (RegistroC830)meta!.Fabrica();
    ...
    {
        const string sped = "|C830|10166.720001/2020-31|1|\r\n";
    ...
    {
        const string sped = "|C830|10166.720001/2020-31|3|\r\n";
