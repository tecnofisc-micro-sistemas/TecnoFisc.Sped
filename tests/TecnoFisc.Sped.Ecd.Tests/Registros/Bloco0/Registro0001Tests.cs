...
/// <summary>
/// Sub-stage 10.002 — exercita a forma do <see cref="Registro0001"/> contra o Manual de
/// Orientação do Leiaute 9 da ECD (p. 76): metadados de catálogo, mapeamento de campo e
