...
/// <summary>Registro T170 - base de cálculo da CSLL no lucro arbitrado.</summary>
[RegistroSped(Codigo = "T170", Nivel = 3, Bloco = "T")]
public sealed partial class RegistroT170 : RegistroSped
{
    /// <inheritdoc />
    public override string Codigo => "T170";
