...
/// Nível hierárquico 4, ocorrência 1:N (filho de M110).
/// Conforme Guia Prático EFD Contribuições v1.35, p. 304.
/// </summary>
[RegistroSped(Codigo = "M115", Nivel = 4, Bloco = "M")]
public sealed partial class RegistroM115 : RegistroSped
{
    public override string Codigo => "M115";

    /// <summary>Detalhamento do valor do crédito reduzido ou acrescido (campo VL_AJ do M110).</summary>
